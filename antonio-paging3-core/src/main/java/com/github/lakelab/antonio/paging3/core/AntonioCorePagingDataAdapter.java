...
public class AntonioCorePagingDataAdapter<ITEM extends TypedModel, VH extends TypedViewHolder<ITEM>>
        extends PagingDataAdapter<ITEM, VH> {
    ...
    public AntonioCorePagingDataAdapter(@NonNull DiffUtil.ItemCallback<ITEM> diffCallback, @NonNull Map<Integer, ViewHolderBuilder> viewHolderBuilderMap) {
        super(diffCallback);
        this.viewHolderBuilderMap = viewHolderBuilderMap;
    }

    public AntonioCorePagingDataAdapter(@NonNull DiffUtil.ItemCallback<ITEM> diffCallback, @NonNull CoroutineDispatcher mainDispatcher, @NonNull CoroutineDispatcher workerDispatcher, @NonNull Map<Integer, ViewHolderBuilder> viewHolderBuilderMap) {
        super(diffCallback, mainDispatcher, workerDispatcher);
        this.viewHolderBuilderMap = viewHolderBuilderMap;
    }

    public AntonioCorePagingDataAdapter(@NonNull DiffUtil.ItemCallback<ITEM> diffCallback, @NonNull CoroutineDispatcher mainDispatcher, @NonNull Map<Integer, ViewHolderBuilder> viewHolderBuilderMap) {
