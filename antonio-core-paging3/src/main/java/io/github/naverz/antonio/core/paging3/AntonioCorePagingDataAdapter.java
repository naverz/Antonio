...
public class AntonioCorePagingDataAdapter<ITEM extends AntonioModel, VH extends TypedViewHolder<ITEM>>
        extends PagingDataAdapter<ITEM, VH> {
    protected final ViewHolderContainer viewHolderContainer;

    public AntonioCorePagingDataAdapter(@NonNull DiffUtil.ItemCallback<ITEM> diffCallback,
    ...
    public void onBindViewHolder(@NonNull VH holder, int position) {
        ...
        try {
            ...
            throw new RuntimeException(
                    Exceptions.errorClassCast(item, holder), e);
        }
    }
